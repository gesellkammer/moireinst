...
;ksmps  = 40   ; this equals a control samplerate of 1000 Hz at 44100
nchnls = 4
0dbfs  = 1
sr     = 44100
...
#define FLUSHSERIAL_NUMCHARS #200#
...
instr FlushSerialRegularly
    ...
    if (ktrig == 1) then
    		event "i", 2, 0, 3/kr, $FLUSHSERIAL_NUMCHARS
    endif
endin
...
skiposc:
	OSCsend ksendtrig, $ADDR_HOST, $ADDR_PORT, "/info", "fffffffffffff", ksmoothfreq, gk_mix, gk_volpedal, gkV0, gkV1, gk_v0post, gk_v1post, gk_vumasterL, gk_vumasterR, gk_vusource, gk_samplerate, gk_vuanalogL, gk_vuanalogR
...
opcode freqshift, aa, akk
    ...
    asin oscili kamp, kfreq, 1
    acos oscili kamp, kfreq, 1, 0.25
    amod1 = areal*acos
    amod2 = aimag*asin
    aup = (amod1 - amod2) * 0.7
...
; i 2 0 3600
f1 0 65536 10 1
i 2 0 0.01 32000 ; flush this number of characters at the beginning of the performance
f 0 36000 
e 
